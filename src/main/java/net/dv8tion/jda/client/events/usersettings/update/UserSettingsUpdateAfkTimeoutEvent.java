 ...
 */
public class UserSettingsUpdateAfkTimeoutEvent extends GenericUserSettingsUpdateEvent
{
    private final int oldValue;

    public UserSettingsUpdateAfkTimeoutEvent(final JDA api, final long responseNumber, final int oldValue)
    {
