 ...
 */
public class GuildSettingsUpdateMobilePushEvent extends GenericGuildSettingsUpdateEvent
{
    private final boolean oldValue;

    public GuildSettingsUpdateMobilePushEvent(final JDA api, final long responseNumber, final Guild guild, final boolean oldValue)
    {
