 ...
 */
public class UserSettingsUpdateInlineEmbedMediaEvent extends GenericUserSettingsUpdateEvent
{
    private final boolean oldValue;

    public UserSettingsUpdateInlineEmbedMediaEvent(final JDA api, final long responseNumber, final boolean oldValue)
    {
