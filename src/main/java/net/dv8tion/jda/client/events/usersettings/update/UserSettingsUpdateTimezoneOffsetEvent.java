 ...
 */
public class UserSettingsUpdateTimezoneOffsetEvent extends GenericUserSettingsUpdateEvent
{
    private final int oldValue;

    public UserSettingsUpdateTimezoneOffsetEvent(final JDA api, final long responseNumber, final int oldValue)
    {
