 ...
 */
public class UserSettingsUpdateFriendSourceFlagsEvent extends GenericUserSettingsUpdateEvent
{
    private final Map<String, Boolean> oldValue;

    public UserSettingsUpdateFriendSourceFlagsEvent(final JDA api, final long responseNumber, final Map<String, Boolean> oldValue)
    {
        super(api, responseNumber);
        this.oldValue = oldValue;
    }

    public Map<String, Boolean> getOldValue()
    {
