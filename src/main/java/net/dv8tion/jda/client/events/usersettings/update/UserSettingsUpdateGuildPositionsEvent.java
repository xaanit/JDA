 ...
 */
public class UserSettingsUpdateGuildPositionsEvent extends GenericUserSettingsUpdateEvent
{
    private final List<Guild> oldValue;

    public UserSettingsUpdateGuildPositionsEvent(final JDA api, final long responseNumber, final List<Guild> oldValue)
    {
