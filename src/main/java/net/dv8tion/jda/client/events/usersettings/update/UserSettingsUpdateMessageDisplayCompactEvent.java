 ...
 */
public class UserSettingsUpdateMessageDisplayCompactEvent extends GenericUserSettingsUpdateEvent
{
    private final boolean oldValue;

    public UserSettingsUpdateMessageDisplayCompactEvent(final JDA api, final long responseNumber, final boolean oldValue)
    {
