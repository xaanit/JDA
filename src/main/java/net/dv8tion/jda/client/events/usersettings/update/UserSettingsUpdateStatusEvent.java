 ...
 */
public class UserSettingsUpdateStatusEvent extends GenericUserSettingsUpdateEvent
{
    private final OnlineStatus oldValue;

    public UserSettingsUpdateStatusEvent(final JDA api, final long responseNumber, final OnlineStatus oldValue)
    {
