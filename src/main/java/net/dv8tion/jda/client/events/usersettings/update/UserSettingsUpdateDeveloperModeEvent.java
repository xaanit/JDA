 ...
 */
public class UserSettingsUpdateDeveloperModeEvent extends GenericUserSettingsUpdateEvent
{
    private final boolean oldValue;

    public UserSettingsUpdateDeveloperModeEvent(final JDA api, final long responseNumber, final boolean oldValue)
    {
