 ...
 */
public class UserSettingsUpdateEmojiConversionEvent extends GenericUserSettingsUpdateEvent
{
    private final boolean oldValue;

    public UserSettingsUpdateEmojiConversionEvent(final JDA api, final long responseNumber, final boolean oldValue)
    {
