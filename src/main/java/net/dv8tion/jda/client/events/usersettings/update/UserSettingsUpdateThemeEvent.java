 ...
 */
public class UserSettingsUpdateThemeEvent extends GenericUserSettingsUpdateEvent
{
    private final UserSettings.Theme oldValue;

    public UserSettingsUpdateThemeEvent(final JDA api, final long responseNumber, final UserSettings.Theme oldValue)
    {
        super(api, responseNumber);
        this.oldValue = oldValue;
    }

    public UserSettings.Theme getOldValue()
    {
