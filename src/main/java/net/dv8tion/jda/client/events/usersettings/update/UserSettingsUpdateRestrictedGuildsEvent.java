 ...
 */
public class UserSettingsUpdateRestrictedGuildsEvent extends GenericUserSettingsUpdateEvent
{
    private final List<Guild> oldValue;

    public UserSettingsUpdateRestrictedGuildsEvent(final JDA api, final long responseNumber, final List<Guild> oldValue)
    {
        super(api, responseNumber);
        this.oldValue = oldValue;
    }

    public List<Guild> getOldValue()
    {
