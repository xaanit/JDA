 ...
 */
public class UserSettingsUpdateLocaleEvent extends GenericUserSettingsUpdateEvent
{
    private final UserSettings.Locale oldValue;

    public UserSettingsUpdateLocaleEvent(final JDA api, final long responseNumber, final UserSettings.Locale oldValue)
    {
        super(api, responseNumber);
        this.oldValue = oldValue;
    }

    public UserSettings.Locale getOldValue()
    {
