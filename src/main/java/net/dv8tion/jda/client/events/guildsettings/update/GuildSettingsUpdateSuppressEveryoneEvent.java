 ...
 */
public class GuildSettingsUpdateSuppressEveryoneEvent extends GenericGuildSettingsUpdateEvent
{
    private final boolean oldValue;

    public GuildSettingsUpdateSuppressEveryoneEvent(final JDA api, final long responseNumber, final Guild guild, final boolean oldValue)
    {
