 ...
 */
public class UserSettingsUpdateRenderEmbedsEvent extends GenericUserSettingsUpdateEvent
{
    private final boolean oldValue;

    public UserSettingsUpdateRenderEmbedsEvent(final JDA api, final long responseNumber, final boolean oldValue)
    {
