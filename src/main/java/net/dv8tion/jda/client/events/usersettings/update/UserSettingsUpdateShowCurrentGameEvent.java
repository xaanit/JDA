 ...
 */
public class UserSettingsUpdateShowCurrentGameEvent extends GenericUserSettingsUpdateEvent
{
    private final boolean oldValue;

    public UserSettingsUpdateShowCurrentGameEvent(final JDA api, final long responseNumber, final boolean oldValue)
    {
