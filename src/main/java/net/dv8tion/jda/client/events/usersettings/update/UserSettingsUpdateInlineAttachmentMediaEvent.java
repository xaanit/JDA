 ...
 */
public class UserSettingsUpdateInlineAttachmentMediaEvent extends GenericUserSettingsUpdateEvent
{
    private final boolean oldValue;

    public UserSettingsUpdateInlineAttachmentMediaEvent(final JDA api, final long responseNumber, final boolean oldValue)
    {
