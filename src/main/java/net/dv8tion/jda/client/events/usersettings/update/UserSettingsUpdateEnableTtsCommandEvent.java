 ...
 */
public class UserSettingsUpdateEnableTtsCommandEvent extends GenericUserSettingsUpdateEvent
{
    private final boolean oldValue;

    public UserSettingsUpdateEnableTtsCommandEvent(final JDA api, final long responseNumber, final boolean oldValue)
    {
