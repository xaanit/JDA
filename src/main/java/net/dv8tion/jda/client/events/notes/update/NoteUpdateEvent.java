...
package net.dv8tion.jda.client.events.notes.update;
 ...
 */
public class NoteUpdateEvent extends Event
{
    private final String oldValue;

    public NoteUpdateEvent(final JDA api, final long responseNumber, final String oldValue)
    {
