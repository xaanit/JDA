 ...
 */
public class UserSettingsUpdateDetectPlatformAccountsEvent extends GenericUserSettingsUpdateEvent
{
    private final boolean oldValue;

    public UserSettingsUpdateDetectPlatformAccountsEvent(final JDA api, final long responseNumber, final boolean oldValue)
    {
