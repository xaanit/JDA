 ...
 */
public class UserSettingsUpdateRenderReactionsEvent extends GenericUserSettingsUpdateEvent
{
    private final boolean oldValue;

    public UserSettingsUpdateRenderReactionsEvent(final JDA api, final long responseNumber, final boolean oldValue)
    {
