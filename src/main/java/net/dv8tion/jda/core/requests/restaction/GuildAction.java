...
import net.dv8tion.jda.core.utils.data.SerializableData;
...
public class GuildAction extends RestAction<Void>
{
    ...
    protected RequestBody finalizeData()
    {
        ...
        object.put("roles", new DataArray(roles));
        if (!channels.isEmpty())
            object.put("channels", new DataArray(channels));
        if (icon != null)
    ...
    public static class RoleData implements SerializableData
    {
        ...
        {
            final DataObject o = new DataObject().put("id", Long.toUnsignedString(id));
            if (permissions != null)
    ...
    public static class ChannelData implements SerializableData
    {
        ...
        public DataObject toDataObject()
        {
            final DataObject o = new DataObject();
            o.put("name", name);
