...
public class ChannelAction extends AuditableRestAction<Channel>
{
    ...
    protected RequestBody finalizeData()
    {
        ...
        DataArray overridesArray = new DataArray(overrides.size());
        for (PromisePermissionOverride override : overrides)
            overridesArray.put(override.toDataObject());
        object.put("permission_overwrites", overridesArray);
