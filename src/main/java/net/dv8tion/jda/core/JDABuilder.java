...
public class JDABuilder
{
    ...
    public JDA buildAsync() throws LoginException, IllegalArgumentException, RateLimitedException
    {
        ...
        JDAImpl jda = new JDAImpl(accountType, httpClientBuilder, wsFactory, shardRateLimiter, autoReconnect, enableVoice,
                              enableShutdownHook, enableBulkDeleteSplitting, requestTimeoutRetry, corePoolSize, maxReconnectDelay,
                              gatewayEncoding);
