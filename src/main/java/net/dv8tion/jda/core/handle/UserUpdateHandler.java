...
public class UserUpdateHandler extends SocketHandler
{
    ...
    protected Long handleInternally(DataObject content)
    {
        ...
        Boolean mobile = content.containsKey("mobile") ? content.getBoolean("mobile") : null; // mobile device
        Boolean nitro = content.containsKey("premium") ? content.getBoolean("premium") : null; // nitro
